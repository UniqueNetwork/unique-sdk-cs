...
namespace Network.Unique.API.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DecodedAttributeDto_name")]
    public partial class DecodedAttributeDtoName : Dictionary<String, string>, IEquatable<DecodedAttributeDtoName>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DecodedAttributeDtoName);
        }

        /// <summary>
        /// Returns true if DecodedAttributeDtoName instances are equal
        /// </summary>
        /// <param name="input">Instance of DecodedAttributeDtoName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DecodedAttributeDtoName input)
        {
            if (input == null)
            {
                return false;
