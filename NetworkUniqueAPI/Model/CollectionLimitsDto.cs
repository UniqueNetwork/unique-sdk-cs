...
namespace Network.Unique.API.Model
{
    ...
    /// CollectionLimitsDto
    /// </summary>
    [DataContract(Name = "CollectionLimitsDto")]
    public partial class CollectionLimitsDto : IEquatable<CollectionLimitsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionLimitsDto" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionLimitsDto {\n");
        ...
        {
            return this.Equals(input as CollectionLimitsDto);
        }

        /// <summary>
        /// Returns true if CollectionLimitsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectionLimitsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionLimitsDto input)
        {
            if (input == null)
            {
                return false;
