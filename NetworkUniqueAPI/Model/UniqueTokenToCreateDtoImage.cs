...
namespace Network.Unique.API.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(UniqueTokenToCreateDtoImageJsonConverter))]
    [DataContract(Name = "UniqueTokenToCreateDto_image")]
    public partial class UniqueTokenToCreateDtoImage : AbstractOpenAPISchema, IEquatable<UniqueTokenToCreateDtoImage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueTokenToCreateDtoImage" /> class
        ...
        public UniqueTokenToCreateDtoImage(UniqueCollectionSchemaDecodedDtoCoverPictureOneOf actualInstance)
        {
        ...
        public UniqueTokenToCreateDtoImage(UniqueCollectionSchemaDecodedDtoCoverPictureOneOf1 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public UniqueTokenToCreateDtoImage(UniqueCollectionSchemaDecodedDtoCoverPictureOneOf2 actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UniqueTokenToCreateDtoImage {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, UniqueTokenToCreateDtoImage.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of UniqueTokenToCreateDtoImage
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of UniqueTokenToCreateDtoImage</returns>
        public static UniqueTokenToCreateDtoImage FromJson(string jsonString)
        {
            UniqueTokenToCreateDtoImage newUniqueTokenToCreateDtoImage = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newUniqueTokenToCreateDtoImage;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf>(jsonString, UniqueTokenToCreateDtoImage.SerializerSettings));
                }
                else
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf>(jsonString, UniqueTokenToCreateDtoImage.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf1>(jsonString, UniqueTokenToCreateDtoImage.SerializerSettings));
                }
                else
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf1>(jsonString, UniqueTokenToCreateDtoImage.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf2>(jsonString, UniqueTokenToCreateDtoImage.SerializerSettings));
                }
                else
                {
                    newUniqueTokenToCreateDtoImage = new UniqueTokenToCreateDtoImage(JsonConvert.DeserializeObject<UniqueCollectionSchemaDecodedDtoCoverPictureOneOf2>(jsonString, UniqueTokenToCreateDtoImage.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as UniqueTokenToCreateDtoImage);
        }

        /// <summary>
        /// Returns true if UniqueTokenToCreateDtoImage instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueTokenToCreateDtoImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueTokenToCreateDtoImage input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for UniqueTokenToCreateDtoImage
    /// </summary>
    public class UniqueTokenToCreateDtoImageJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(UniqueTokenToCreateDtoImage).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return UniqueTokenToCreateDtoImage.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
