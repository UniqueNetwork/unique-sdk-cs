...
namespace Network.Unique.API.Model
{
    ...
    /// BurnTokenResponse
    /// </summary>
    [DataContract(Name = "BurnTokenResponse")]
    public partial class BurnTokenResponse : IEquatable<BurnTokenResponse>, IValidatableObject
    {
        ...
        public BurnTokenResponse(bool isError = default(bool), FeeResponse fee = default(FeeResponse), BurnTokenParsed parsed = default(BurnTokenParsed))
        {
            this.IsError = isError;
            // to ensure "parsed" is required (not null)
            if (parsed == null)
            {
                throw new ArgumentNullException("parsed is a required property for BurnTokenResponse and cannot be null");
            }
            this.Parsed = parsed;
            this.Fee = fee;
        }
        ...
        public BurnTokenParsed Parsed { get; set; }
