...
namespace Network.Unique.API.Model
{
    ...
    public partial class BalanceResponse : IEquatable<BalanceResponse>, IValidatableObject
    {
        ...
        public BalanceResponse(string raw = default(string), string amount = default(string), string formatted = default(string), string unit = default(string), decimal decimals = default(decimal))
        {
            // to ensure "raw" is required (not null)
            if (raw == null)
            {
                throw new ArgumentNullException("raw is a required property for BalanceResponse and cannot be null");
            }
            this.Raw = raw;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for BalanceResponse and cannot be null");
            }
            this.Amount = amount;
            // to ensure "formatted" is required (not null)
            if (formatted == null)
            {
                throw new ArgumentNullException("formatted is a required property for BalanceResponse and cannot be null");
            }
            this.Formatted = formatted;
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for BalanceResponse and cannot be null");
            }
            this.Unit = unit;
