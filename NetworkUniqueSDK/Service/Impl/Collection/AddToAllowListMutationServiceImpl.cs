...
public class AddToAllowListMutationServiceImpl : MutationService<AddToAllowListBody>
{
    ...
    public AddToAllowListMutationServiceImpl(SignerWrapper signerWrapper, CollectionsApi api)
    {
        this._signerWrapper = signerWrapper;
        this._api = api;
    }

    public AddToAllowListMutationServiceImpl(SignerWrapper signerWrapper, string basePath)
    {
        this._signerWrapper = signerWrapper;
