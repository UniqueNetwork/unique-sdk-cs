...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class EvmApi : IEvmApi
    {
        ...
        /// <returns></returns>
        public EvmApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public EvmApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = EvmControllerEvmCallWithHttpInfo(evmCallArgumentsDto);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> EvmControllerEvmCallWithHttpInfo(EvmCallArgumentsDto evmCallArgumentsDto, int operationIndex = 0)
        {
            // verify the required parameter 'evmCallArgumentsDto' is set
            if (evmCallArgumentsDto == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'evmCallArgumentsDto' when calling EvmApi->EvmControllerEvmCall");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = await EvmControllerEvmCallWithHttpInfoAsync(evmCallArgumentsDto, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> EvmControllerEvmCallWithHttpInfoAsync(EvmCallArgumentsDto evmCallArgumentsDto, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'evmCallArgumentsDto' is set
            if (evmCallArgumentsDto == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<EvmContractExistsResponseDto> localVarResponse = EvmControllerEvmExistWithHttpInfo(contractAddress);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EvmContractExistsResponseDto</returns>
        public Org.OpenAPITools.Client.ApiResponse<EvmContractExistsResponseDto> EvmControllerEvmExistWithHttpInfo(string contractAddress, int operationIndex = 0)
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'contractAddress' when calling EvmApi->EvmControllerEvmExist");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "contractAddress", contractAddress));
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<EvmContractExistsResponseDto> localVarResponse = await EvmControllerEvmExistWithHttpInfoAsync(contractAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EvmContractExistsResponseDto)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<EvmContractExistsResponseDto>> EvmControllerEvmExistWithHttpInfoAsync(string contractAddress, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<EvmSendMutationDefaultResponse> localVarResponse = EvmSendMutationWithHttpInfo(evmSendMutationRequest, use, withFee, verify, callbackUrl, nonce);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EvmSendMutationDefaultResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<EvmSendMutationDefaultResponse> EvmSendMutationWithHttpInfo(EvmSendMutationRequest evmSendMutationRequest, string use = default(string), bool? withFee = default(bool?), bool? verify = default(bool?), string callbackUrl = default(string), decimal? nonce = default(decimal?), int operationIndex = 0)
        {
            // verify the required parameter 'evmSendMutationRequest' is set
            if (evmSendMutationRequest == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'evmSendMutationRequest' when calling EvmApi->EvmSendMutation");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<EvmSendMutationDefaultResponse> localVarResponse = await EvmSendMutationWithHttpInfoAsync(evmSendMutationRequest, use, withFee, verify, callbackUrl, nonce, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EvmSendMutationDefaultResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<EvmSendMutationDefaultResponse>> EvmSendMutationWithHttpInfoAsync(EvmSendMutationRequest evmSendMutationRequest, string use = default(string), bool? withFee = default(bool?), bool? verify = default(bool?), string callbackUrl = default(string), decimal? nonce = default(decimal?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'evmSendMutationRequest' is set
            if (evmSendMutationRequest == null)
            {
