...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class QueryApi : IQueryApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = QueryControllerGetWithHttpInfo(endpoint, module, method);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> QueryControllerGetWithHttpInfo(string endpoint, string module, string method, int operationIndex = 0)
        {
            // verify the required parameter 'endpoint' is set
            if (endpoint == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'endpoint' when calling QueryApi->QueryControllerGet");
            }

            // verify the required parameter 'module' is set
            if (module == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'module' when calling QueryApi->QueryControllerGet");
            }

            // verify the required parameter 'method' is set
            if (method == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'method' when calling QueryApi->QueryControllerGet");
            }
            ...
            localVarRequestOptions.PathParameters.Add("endpoint", Org.OpenAPITools.Client.ClientUtils.ParameterToString(endpoint)); // path parameter
            localVarRequestOptions.PathParameters.Add("module", Org.OpenAPITools.Client.ClientUtils.ParameterToString(module)); // path parameter
            localVarRequestOptions.PathParameters.Add("method", Org.OpenAPITools.Client.ClientUtils.ParameterToString(method)); // path parameter
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = await QueryControllerGetWithHttpInfoAsync(endpoint, module, method, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<Object>> QueryControllerGetWithHttpInfoAsync(string endpoint, string module, string method, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'endpoint' is set
            if (endpoint == null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = QueryControllerQueryWithHttpInfo(endpoint, module, method, apiRequestBody);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object</returns>
        public Org.OpenAPITools.Client.ApiResponse<Object> QueryControllerQueryWithHttpInfo(string endpoint, string module, string method, ApiRequestBody apiRequestBody, int operationIndex = 0)
        {
            // verify the required parameter 'endpoint' is set
            if (endpoint == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'endpoint' when calling QueryApi->QueryControllerQuery");
            }

            // verify the required parameter 'module' is set
            if (module == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'module' when calling QueryApi->QueryControllerQuery");
            }

            // verify the required parameter 'method' is set
            if (method == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'method' when calling QueryApi->QueryControllerQuery");
            }

            // verify the required parameter 'apiRequestBody' is set
            if (apiRequestBody == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'apiRequestBody' when calling QueryApi->QueryControllerQuery");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<Object> localVarResponse = await QueryControllerQueryWithHttpInfoAsync(endpoint, module, method, apiRequestBody, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
