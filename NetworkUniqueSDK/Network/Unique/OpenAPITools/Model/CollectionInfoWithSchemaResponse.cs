...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionInfoWithSchemaResponse")]
    public partial class CollectionInfoWithSchemaResponse : IEquatable<CollectionInfoWithSchemaResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Mode
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionInfoWithSchemaResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CollectionInfoWithSchemaResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionInfoWithSchemaResponse" /> class.
        /// </summary>
        ...
        /// <param name="tokenPropertyPermissions">tokenPropertyPermissions (required).</param>
        public CollectionInfoWithSchemaResponse(ModeEnum? mode = default(ModeEnum?), string name = default(string), string description = default(string), string tokenPrefix = default(string), CollectionSponsorship sponsorship = default(CollectionSponsorship), CollectionLimitsDto limits = default(CollectionLimitsDto), MetaUpdatePermissionEnum? metaUpdatePermission = default(MetaUpdatePermissionEnum?), CollectionPermissionsDto permissions = default(CollectionPermissionsDto), bool readOnly = default(bool), decimal id = default(decimal), string owner = default(string), UniqueCollectionSchemaDecodedDto schema = default(UniqueCollectionSchemaDecodedDto), List<CollectionProperty> properties = default(List<CollectionProperty>), CollectionFlags flags = default(CollectionFlags), List<CollectionPropertyKeyPermission> tokenPropertyPermissions = default(List<CollectionPropertyKeyPermission>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            this.Description = description;
            // to ensure "tokenPrefix" is required (not null)
            if (tokenPrefix == null)
            {
                throw new ArgumentNullException("tokenPrefix is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            ...
            if (owner == null)
            {
                throw new ArgumentNullException("owner is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            this.Owner = owner;
            // to ensure "properties" is required (not null)
            if (properties == null)
            {
                throw new ArgumentNullException("properties is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            this.Properties = properties;
            // to ensure "flags" is required (not null)
            if (flags == null)
            {
                throw new ArgumentNullException("flags is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
            this.Flags = flags;
            // to ensure "tokenPropertyPermissions" is required (not null)
            if (tokenPropertyPermissions == null)
            {
                throw new ArgumentNullException("tokenPropertyPermissions is a required property for CollectionInfoWithSchemaResponse and cannot be null");
            }
        ...
        public UniqueCollectionSchemaDecodedDto Schema { get; set; }
        ...
        public CollectionFlags Flags { get; set; }

        /// <summary>
        /// Gets or Sets TokenPropertyPermissions
        /// </summary>
        [DataMember(Name = "tokenPropertyPermissions", IsRequired = true, EmitDefaultValue = true)]
        public List<CollectionPropertyKeyPermission> TokenPropertyPermissions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionInfoWithSchemaResponse {\n");
        ...
        {
            return this.Equals(input as CollectionInfoWithSchemaResponse);
        }

        /// <summary>
        /// Returns true if CollectionInfoWithSchemaResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectionInfoWithSchemaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionInfoWithSchemaResponse input)
        {
            if (input == null)
            {
                return false;
