...
namespace Org.OpenAPITools.Model
{
    ...
    /// PropertyPermission
    /// </summary>
    [DataContract(Name = "PropertyPermission")]
    public partial class PropertyPermission : IEquatable<PropertyPermission>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyPermission" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="PropertyPermission" /> class.
        /// </summary>
        /// <param name="mutable">mutable (required) (default to true).</param>
        /// <param name="collectionAdmin">collectionAdmin (required) (default to true).</param>
        /// <param name="tokenOwner">tokenOwner (required) (default to true).</param>
        public PropertyPermission(bool mutable = true, bool collectionAdmin = true, bool tokenOwner = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyPermission {\n");
        ...
        {
            return this.Equals(input as PropertyPermission);
        }

        /// <summary>
        /// Returns true if PropertyPermission instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyPermission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyPermission input)
        {
            if (input == null)
            {
                return false;
