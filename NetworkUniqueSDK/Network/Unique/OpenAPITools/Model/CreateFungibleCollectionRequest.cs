...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateFungibleCollectionRequest")]
    public partial class CreateFungibleCollectionRequest : IEquatable<CreateFungibleCollectionRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines Mode
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFungibleCollectionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateFungibleCollectionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFungibleCollectionRequest" /> class.
        /// </summary>
        ...
        public CreateFungibleCollectionRequest(ModeEnum? mode = default(ModeEnum?), string name = default(string), string description = default(string), string tokenPrefix = default(string), CollectionSponsorship sponsorship = default(CollectionSponsorship), CollectionLimitsDto limits = default(CollectionLimitsDto), MetaUpdatePermissionEnum? metaUpdatePermission = default(MetaUpdatePermissionEnum?), CollectionPermissionsDto permissions = default(CollectionPermissionsDto), bool readOnly = default(bool), string address = default(string), UniqueCollectionSchemaToCreateDto schema = default(UniqueCollectionSchemaToCreateDto), List<CollectionProperty> properties = default(List<CollectionProperty>), List<PropertyKeyPermission> tokenPropertyPermissions = default(List<PropertyKeyPermission>), int decimals = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateFungibleCollectionRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CreateFungibleCollectionRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "tokenPrefix" is required (not null)
            if (tokenPrefix == null)
            {
                throw new ArgumentNullException("tokenPrefix is a required property for CreateFungibleCollectionRequest and cannot be null");
            }
            this.TokenPrefix = tokenPrefix;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CreateFungibleCollectionRequest and cannot be null");
            }
        ...
        public UniqueCollectionSchemaToCreateDto Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateFungibleCollectionRequest {\n");
        ...
        {
            return this.Equals(input as CreateFungibleCollectionRequest);
        }

        /// <summary>
        /// Returns true if CreateFungibleCollectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateFungibleCollectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateFungibleCollectionRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Decimals > (int)18)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Decimals, must be a value less than or equal to 18.", new [] { "Decimals" });
            }
