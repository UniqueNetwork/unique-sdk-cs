...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BalanceTransferResponse : IEquatable<BalanceTransferResponse>, IValidatableObject
    {
        ...
        public BalanceTransferResponse(bool isError = default(bool), FeeResponse fee = default(FeeResponse), BalanceTransferParsed parsed = default(BalanceTransferParsed))
        {
            this.IsError = isError;
            // to ensure "parsed" is required (not null)
            if (parsed == null)
            {
                throw new ArgumentNullException("parsed is a required property for BalanceTransferResponse and cannot be null");
            }
            this.Parsed = parsed;
            this.Fee = fee;
        }
        ...
        public BalanceTransferParsed Parsed { get; set; }
