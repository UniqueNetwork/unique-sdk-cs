...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SubmitResponse : IEquatable<SubmitResponse>, IValidatableObject
    {
        ...
        public SubmitResponse(string hash = default(string), FeeResponse fee = default(FeeResponse))
        {
            // to ensure "hash" is required (not null)
            if (hash == null)
            {
                throw new ArgumentNullException("hash is a required property for SubmitResponse and cannot be null");
            }
            this.Hash = hash;
            this.Fee = fee;
        }
