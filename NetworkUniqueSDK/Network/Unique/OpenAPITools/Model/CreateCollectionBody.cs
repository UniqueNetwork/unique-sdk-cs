...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCollectionBody")]
    public partial class CreateCollectionBody : IEquatable<CreateCollectionBody>, IValidatableObject
    {
        /// <summary>
        /// Defines Mode
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCollectionBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCollectionBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCollectionBody" /> class.
        /// </summary>
        ...
        public CreateCollectionBody(ModeEnum? mode = default(ModeEnum?), string name = default(string), string description = default(string), string tokenPrefix = default(string), CollectionSponsorship sponsorship = default(CollectionSponsorship), CollectionLimitsDto limits = default(CollectionLimitsDto), MetaUpdatePermissionEnum? metaUpdatePermission = default(MetaUpdatePermissionEnum?), CollectionPermissionsDto permissions = default(CollectionPermissionsDto), bool readOnly = default(bool), string address = default(string), UniqueCollectionSchemaToCreateDto schema = default(UniqueCollectionSchemaToCreateDto), List<CollectionProperty> properties = default(List<CollectionProperty>), List<PropertyKeyPermission> tokenPropertyPermissions = default(List<PropertyKeyPermission>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateCollectionBody and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CreateCollectionBody and cannot be null");
            }
            this.Description = description;
            // to ensure "tokenPrefix" is required (not null)
            if (tokenPrefix == null)
            {
                throw new ArgumentNullException("tokenPrefix is a required property for CreateCollectionBody and cannot be null");
            }
            this.TokenPrefix = tokenPrefix;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CreateCollectionBody and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateCollectionBody);
        }

        /// <summary>
        /// Returns true if CreateCollectionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCollectionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCollectionBody input)
        {
            if (input == null)
            {
                return false;
