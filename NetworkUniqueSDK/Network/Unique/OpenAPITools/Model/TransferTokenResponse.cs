...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TransferTokenResponse : IEquatable<TransferTokenResponse>, IValidatableObject
    {
        ...
        public TransferTokenResponse(bool isError = default(bool), FeeResponse fee = default(FeeResponse), TransferTokenParsed parsed = default(TransferTokenParsed))
        {
            this.IsError = isError;
            // to ensure "parsed" is required (not null)
            if (parsed == null)
            {
                throw new ArgumentNullException("parsed is a required property for TransferTokenResponse and cannot be null");
            }
            this.Parsed = parsed;
            this.Fee = fee;
        }
        ...
        public TransferTokenParsed Parsed { get; set; }
